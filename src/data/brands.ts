...
export const brands: Brand[] = [
  { slug: "medonix-pharma", name: "Aadya Medicine Agencies", tagline: "Our In-House Excellence", description: "Premium in-house formulations across critical therapeutic segments, manufactured under strict WHO-GMP standards.", color: "from-emerald-700 to-amber-500", founded: "2008", country: "India" },
...
const brandCatalog: Record<string, Array<{ name: string; cat: keyof typeof imgMap; composition: string }>> = {
  ...
  "medonix-pharma": [
    { name: "Aadya Medicine Pain-X 100", cat: "tablets", composition: "Aceclofenac" },
    { name: "Aadya Medicine B-Complex Forte", cat: "capsules", composition: "Vitamin B Complex" },
    { name: "Aadya Medicine Cough Relief", cat: "syrups", composition: "Dextromethorphan + CPM" },
    { name: "Aadya Medicine Calci-D3", cat: "tablets", composition: "Calcium + Vit D3" },
    { name: "Aadya Medicine Antiseptic Cream", cat: "ointments", composition: "Chlorhexidine + Cetrimide" },
    { name: "Aadya Medicine Iron Tonic", cat: "syrups", composition: "Ferrous Ascorbate + Folic Acid" },
  ],
};
...
for (const b of brands) {
  ...
  items.forEach((it, i) => {
    ...
    brandProducts.push({
      ...
      description: `${it.name} by ${b.name} — authentic, quality-assured pharmaceutical product distributed by Aadya Medicine Agencies. Manufactured under strict GMP standards. Store in a cool, dry place. Read leaflet before use.`,
    });
    nextId++;
  });
}
