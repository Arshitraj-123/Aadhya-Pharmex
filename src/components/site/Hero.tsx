  ...
  />
      ...
      <div className="relative container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center py-20">
        ...
        <div className="text-white">
          ...
          >
            Aadya Medicine Agencies delivers premium medicines from 50+ trusted brands — blending Ayurvedic wisdom with modern pharmacology, shipped to 400+ retailers nationwide.
          </motion.p>
        ...
        <div className="relative hidden lg:flex justify-center items-center">
          ...
          >
            ...
            >
              ...
              <img
                src={productImg}
                alt="Aadya Medicine Agencies premium herbal medicine"
                width={1024}
                height={1024}
