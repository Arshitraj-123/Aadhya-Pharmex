...
export const Route = createFileRoute("/about/testimonials")({
  head: () => ({
    meta: [
      { title: "Testimonials — Aadya Medicine Agencies" },
      { name: "description", content: "Read what our 400+ retail partners and hospitals say about working with Aadya Medicine Agencies." },
    ],
  }),
...
const items = [
  { name: "Dr. Anita Sharma", role: "Owner, Apex Pharmacy", text: "Aadya Medicine Agencies has been our primary distributor for 6 years. Their on-time delivery and authentic stock have transformed how we serve our patients." },
  ...
  { name: "Dr. Rakesh Kumar", role: "Director, City Hospital", text: "We trust Aadya Medicine Agencies for hospital-grade injectables. Quality is consistent and pricing is competitive." },
  ...
  { name: "Mohammed Faisal", role: "Pharmacy Chain Manager", text: "Across 14 stores, Aadya Medicine Agencies is our most dependable partner. Zero compromises on authenticity." },
  { name: "Dr. Lakshmi Rao", role: "Clinical Pharmacologist", text: "I recommend Aadya Medicine Agencies to every clinic I consult for. Their compliance and traceability are exemplary." },
];
