...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Us — Aadya Medicine Agencies" },
      { name: "description", content: "Discover Aadya Medicine Agencies — a trusted pharmaceutical distributor serving retailers across Uttar Pradesh." },
      { property: "og:title", content: "About Us — Aadya Medicine Agencies" },
      { property: "og:description", content: "Trusted pharmaceutical distribution from Saharanpur." },
    ],
  }),
  component: AboutPage,
});
...
function AboutPage() {
  return (
    <PageShell>
      <PageHeader eyebrow="About Aadya Medicine Agencies" title="Distributing Trust Since 2003" subtitle="Two decades of building India's most reliable pharmaceutical supply network." />
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Aadya Medicine Agencies is a trusted pharmaceutical distributor based in Saharanpur, Uttar Pradesh. We have built a reputation for authenticity, on-time delivery and an uncompromising quality standard.
            </p>
