...
export const Route = createFileRoute("/about/ceo")({
  head: () => ({
    meta: [
      { title: "CEO Desk — Aadya Medicine Agencies" },
      { name: "description", content: "A personal message from our CEO on the values, vision and people behind Aadya Medicine Agencies." },
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-[400px_1fr] gap-12 items-start max-w-6xl">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-2xl font-medium leading-relaxed text-foreground">
              When we started Aadya Medicine Agencies in 2003, our promise was simple: every medicine we deliver should be authentic, on-time, and traceable.
            </p>
            <div className="mt-6 space-y-4 text-muted-foreground leading-relaxed">
              ...
              <p>Thank you for being part of our journey. Whether you're a retailer, a manufacturer, or a patient receiving care — you make Aadya Medicine Agencies what it is.</p>
            </div>
